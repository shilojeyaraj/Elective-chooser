#!/usr/bin/env python3
"""
Check what courses are missing from the database
"""
...
def check_missing_courses():
    ...
    required_courses = get_all_required_courses()
    ...
    missing_courses = required_courses - existing_courses
    
    print(f"📚 Total courses in database: {len(existing_courses)}")
    print(f"🔍 Total required courses: {len(required_courses)}")
    ...
    if missing_courses:
        ...
        print("\n✅ All required courses exist in the database!")
