#!/usr/bin/env python3
"""
Script to ingest courses from waterloo_courses_other.json
"""
...
def ingest_waterloo_other(json_file_path: str):
    """Ingest courses from waterloo_courses_other.json"""
    ...
    for course_data in courses_data:
        ...
        try:
            ...
            if dept in ['CS']:
                faculty = 'Mathematics'
            elif dept in ['ECE', 'ME', 'CHE', 'CIVE', 'ENVE', 'GEOE', 'MSE', 'MTE', 'NE', 'SYDE']:
                faculty = 'Engineering'
...
if __name__ == "__main__":
    json_file = 'waterloo_courses_other.json'
    ingest_waterloo_other(json_file)
