#!/usr/bin/env python3
"""
Script to ingest CHEM and CHE courses from uw_courses_CHEM_CHE.json
"""
...
def ingest_chem_che_courses(json_file_path: str):
    """Ingest CHEM and CHE courses from JSON file"""
    print(f"📥 Ingesting CHEM and CHE courses from: {json_file_path}")
    ...
    if failed_count == 0:
        print("🎉 CHEM and CHE courses have been ingested successfully!")
    else:
        print("⚠️ Some courses failed to ingest. Check logs for details.")

if __name__ == "__main__":
    json_file = 'uw_courses_CHEM_CHE.json'
    ingest_chem_che_courses(json_file)
